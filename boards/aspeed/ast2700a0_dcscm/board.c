...
static int ast2700a0_dcscm_post_init(void)
{
...
static int ast2700a0_dcscm_init(void)
{
...
static int ast2700a0_sgpio_workaround_init(void)
{
...
SYS_INIT(ast2700a0_sgpio_workaround_init, POST_KERNEL, 45);
SYS_INIT(ast2700a0_dcscm_post_init, POST_KERNEL, 60);
SYS_INIT(ast2700a0_dcscm_init, APPLICATION, 0);
